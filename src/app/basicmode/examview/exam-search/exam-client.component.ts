...
@Component({
 	selector: 'exam-client',
	templateUrl: './exam-client.component.html'
})

export class ExamClientComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        let receive = this._dashboard.examStore$.subscribe(res => {			
