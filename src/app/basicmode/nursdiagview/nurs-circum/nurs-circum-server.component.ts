...
@Component({
 	selector: 'nurs-circum-server',
	templateUrl: './nurs-circum-server.component.html'
})

export class NursCircumServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.NursCircum[] = [];
	selectedRowsData: Model.NursCircum;
	totalCount: string;
	resultCount: string;
	...
	ngOnInit() {
		this._dashboard.nursCircumStore$.subscribe(res => {
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.NursCircum[]) {
