...
@Component({
 	selector: 'nurs-circum-client',
	templateUrl: './nurs-circum-client.component.html'
})

export class NursCircumClientComponent implements OnInit {
	@ViewChild('accNursCircum') acc;
    ...
    ngOnInit() {
        ...
        let receive = this._dashboard.nursCircumStore$.subscribe(res => {			
