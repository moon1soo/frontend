...
@Injectable()
export class NursPlanService {
	appurl: string;
	headers = new Headers({
		"Accept": "text/plain;charset=UTF-8"
	});
	secCode: string =  'nursPlan';

	serverData: Model.NursPlan[] = [];
	serverClone: Model.NursPlan[] = [];
