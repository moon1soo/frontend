...
@Component({
 	selector: 'nurs-plan-client',
	templateUrl: './nurs-plan-client.component.html'
})

export class NursPlanClientComponent implements OnInit {
	@ViewChild('accNursPlan') acc;
    ...
    ngOnInit() {
        ...
        let receive = this._dashboard.nursPlanStore$.subscribe(res => {
