...
@Component({
 	selector: 'nurs-diag-server',
	templateUrl: './nurs-diag-server.component.html'
})

export class NursDiagServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.NursDiag[] = [];
	...
	ngOnInit() {
		this._dashboard.nursDiagStore$.subscribe(res => {
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.NursDiag[]) {
