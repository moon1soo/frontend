...
import { NursDeptService } from './nurs-dept.service';
...
@Component({
 	selector: 'nurs-dept-server',
	templateUrl: './nurs-dept-server.component.html'
})

export class NursDeptServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.NursDept[] = [];
	selectedRowsData: Model.NursDept;
	totalCount: string;
	resultCount: string;
	...
	constructor(
		...
		private _service: NursDeptService,
	...
	ngOnInit() {
		this._dashboard.nursDeptStore$.subscribe(res => {
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.NursDept[]) {
