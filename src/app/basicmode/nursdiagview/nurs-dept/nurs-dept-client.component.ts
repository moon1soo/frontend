...
@Component({
 	selector: 'nurs-dept-client',
	templateUrl: './nurs-dept-client.component.html'
})

export class NursDeptClientComponent implements OnInit {
	@ViewChild('accNursDept') acc;
    ...
    ngOnInit() {
        ...
        let receive = this._dashboard.nursDeptStore$.subscribe(res => {
