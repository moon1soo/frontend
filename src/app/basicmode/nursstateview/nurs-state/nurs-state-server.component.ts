...
@Component({
 	selector: 'nurs-state-server',
	templateUrl: './nurs-state-server.component.html'
})

export class NursStateServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.NursState[] = [];
