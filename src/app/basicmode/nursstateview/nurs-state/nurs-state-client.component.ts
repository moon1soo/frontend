...
@Component({
 	selector: 'nurs-state-client',
	templateUrl: './nurs-state-client.component.html'
})

export class NursStateClientComponent implements OnInit {
	@ViewChild('accNursState') acc;	
    ...
    ngOnInit() {
        ...
        let receive = this._dashboard.nursStateStore$.subscribe(res => {			
