...
@Component({
 	selector: 'nurs-state-eav-server',
	templateUrl: './nurs-state-eav-server.component.html'
})

export class NursStateEavServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.NursStateEav[] = [];
	...
	ngOnInit() {
		this._dashboard.nursStateEavStore$.subscribe(res => {
