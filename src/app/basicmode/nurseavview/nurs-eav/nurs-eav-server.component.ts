...
@Component({
 	selector: 'nurs-eav-server',
	templateUrl: './nurs-eav-server.component.html'
})

export class NursEavServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.NursEav[] = [];
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.NursEav[]) {
