...
@Component({
 	selector: 'diag-medical-server',
	templateUrl: './diag-medical-server.component.html'
})

export class DiagMedicalServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;
	@Output() select = new EventEmitter();

	dataSource: Model.DiagMedicalList[] = [];
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.DiagMedicalList[]) {
