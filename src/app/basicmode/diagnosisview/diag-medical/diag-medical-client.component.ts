...
@Component({
 	selector: 'diag-medical-client',
	templateUrl: './diag-medical-client.component.html'
})

export class DiagMedicalClientComponent implements OnInit {
	@ViewChild('accDiagMed') acc;
    ...
    ngOnInit() {
        ...
        let receive = this._dashboard.diagMedicalStore$.subscribe(res => {
