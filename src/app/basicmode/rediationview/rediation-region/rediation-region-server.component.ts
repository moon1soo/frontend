...
@Component({
 	selector: 'rediation-region-server',
	templateUrl: './rediation-region-server.component.html'
})

export class RediationRegionServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.RediationRegionList[] = [];
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.RediationRegionList[]) {
