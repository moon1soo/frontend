...
@Component({
	selector: 'rediation-region-client',
	templateUrl: './rediation-region-client.component.html'
})

export class RediationRegionClientComponent implements OnInit {
	@ViewChild('accRediationRegion') acc;
	...
	ngOnInit() {
		...
		let receive = this._dashboard.rediationTherapyRegionStore$.subscribe(res => {
