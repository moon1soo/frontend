...
@Component({
	selector: 'rediation-room-client',
	templateUrl: './rediation-room-client.component.html'
})

export class RediationRoomClientComponent implements OnInit {
	@ViewChild('accRediationRoom') acc;
	...
	ngOnInit() {
		...
		let receive = this._dashboard.rediationTherapyRoomStore$.subscribe(res => {
