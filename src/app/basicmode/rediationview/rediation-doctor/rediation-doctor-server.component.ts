...
@Component({
 	selector: 'rediation-doctor-server',
	templateUrl: './rediation-doctor-server.component.html'
})

export class RediationDoctorServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.RediationDoctorList[] = [];
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.RediationDoctorList[]) {
