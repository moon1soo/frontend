...
@Component({
	selector: 'rediation-doctor-client',
	templateUrl: './rediation-doctor-client.component.html'
})

export class RediationDoctorClientComponent implements OnInit {
	@ViewChild('accRediationDoctor') acc;
	...
	ngOnInit() {
		...
		let receive = this._dashboard.rediationDoctorStore$.subscribe(res => {
