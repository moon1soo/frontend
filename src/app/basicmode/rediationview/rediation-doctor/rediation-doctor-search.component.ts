...
@Component({
 	selector: 'rediation-doctor-search',
	templateUrl: './rediation-doctor-search.component.html',
	providers: [ RediationDoctorService ]
})

export class RediationDoctorSearchComponent implements OnInit {
