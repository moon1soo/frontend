...
@Component({
	selector: 'rediation-client',
	templateUrl: './rediation-client.component.html'
})

export class RediationClientComponent implements OnInit {
	@ViewChild('accRediation') acc;
	...
	ngOnInit() {
		...
		let receive = this._dashboard.rediationTreatmentStore$.subscribe(res => {
