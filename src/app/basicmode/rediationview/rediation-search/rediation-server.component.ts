...
@Component({
 	selector: 'rediation-server',
	templateUrl: './rediation-server.component.html'
})

export class RediationServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.RediationList[] = [];
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.RediationList[]) {
