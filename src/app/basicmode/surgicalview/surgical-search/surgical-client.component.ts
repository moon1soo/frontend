...
@Component({
	selector: 'surgical-client',
	templateUrl: './surgical-client.component.html'
})

export class SurgicalClientComponent implements OnInit {
	@ViewChild('accSurgical') acc;
	...
	ngOnInit() {
		...
		let receive = this._dashboard.surgicalStore$.subscribe(res => {
