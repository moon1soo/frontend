...
@Component({
 	selector: 'surgical-server',
	templateUrl: './surgical-server.component.html'
})

export class SurgicalServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.SurgicalList[] = [];
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.SurgicalList[]) {
