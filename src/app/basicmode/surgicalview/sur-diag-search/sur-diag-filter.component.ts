...
@Component({
 	selector: 'sur-diag-filter',
	templateUrl: './sur-diag-filter.component.html'
})

export class SurDiagFilterComponent implements OnInit {	
	dataSource: any;
    ...
    onDeleteRow(data: Model.SurDiag): void {
