...
@Component({
 	selector: 'sur-diag-client',
	templateUrl: './sur-diag-client.component.html'
})

export class SurDiagClientComponent implements OnInit {
	@ViewChild('accSurDiag') acc;
    ...
    ngOnInit() {
        ...
        let receive = this._dashboard.surDiagStore$.subscribe(res => {			
