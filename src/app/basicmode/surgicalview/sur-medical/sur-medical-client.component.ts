...
@Component({
 	selector: 'sur-medical-client',
	templateUrl: './sur-medical-client.component.html'
})

export class SurMedicalClientComponent implements OnInit {
    @ViewChild('accSurMed') acc;
    ...
    ngOnInit() {
        ...
        let receive = this._dashboard.surgicalMedicalStore$.subscribe(res => {			
