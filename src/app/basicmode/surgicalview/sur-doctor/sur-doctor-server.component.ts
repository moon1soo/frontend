...
@Component({
 	selector: 'sur-doctor-server',
	templateUrl: './sur-doctor-server.component.html'
})

export class SurDoctorServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;
	@Output() select = new EventEmitter();

	dataSource: Model.SurDoctor[] = [];
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.SurDoctor[]) {
