...
@Component({
 	selector: 'sur-doctor-client',
	templateUrl: './sur-doctor-client.component.html'
})

export class SurDoctorClientComponent implements OnInit {
    @ViewChild('accSurDoc') acc;
    ...
    ngOnInit() {
        ...
        let receive = this._dashboard.surDoctorStore$.subscribe(res => {			
