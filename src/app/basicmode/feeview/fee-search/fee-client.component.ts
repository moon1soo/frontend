...
@Component({
 	selector: 'fee-client',
	templateUrl: './fee-client.component.html'
})

export class FeeClientComponent implements OnInit {
	@ViewChild('accFee') acc;
    ...
    ngOnInit() {
		...
		let receive =  this._dashboard.feeStore$.subscribe(res => {
