...
@Component({
 	selector: 'medicine-client',
	templateUrl: './medicine-client.component.html'
})

export class MedicineClientComponent implements OnInit {
	@ViewChild('accMedicine') acc;
    ...
    ngOnInit() {
        ...
        let receive = this._dashboard.medicineStore$.subscribe(res => {			
