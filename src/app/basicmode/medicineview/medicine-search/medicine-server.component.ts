...
@Component({
 	selector: 'medicine-server',
	templateUrl: './medicine-server.component.html'
})

export class MedicineServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;
	
	dataSource: Model.MedicineList[] = [];
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.MedicineList[]) {
