...
@Component({
	selector: 'surgical-interim',
	templateUrl: './surgical-interim.component.html'
})

export class SurgicalInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.SurgicalInterim[] = [];
	totalCount: string;
	loading: boolean;
    
	seqCode: string = 'surgical';
