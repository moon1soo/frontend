...
@Component({
	selector: 'form-interim',
	templateUrl: './form-interim.component.html'
})

export class FormInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.FormInterim[] = [];
	totalCount: string;
	loading: boolean;
