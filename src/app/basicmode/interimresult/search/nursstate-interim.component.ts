...
@Component({
	selector: 'nursstate-interim',
	templateUrl: './nursstate-interim.component.html'
})

export class NursStateInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.NursStateInterim[] = [];
	totalCount: string;
	loading: boolean;
    
	seqCode: string = 'nursState';
