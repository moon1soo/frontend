...
@Component({
	selector: 'exam-result-interim',
	templateUrl: './exam-result-interim.component.html'
})

export class ExamResultInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.ExamInterim[] = [];
    totalCount: string;
    
	seqCode: string = 'examResult';
	loading: boolean;
