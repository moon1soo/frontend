...
@Component({
	selector: 'rediation-interim',
	templateUrl: './rediation-interim.component.html'
})

export class RediationInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.RediationInterim[] = [];
	totalCount: string;
	loading: boolean;
    
	seqCode: string = 'rediation';
