...
@Component({
	selector: 'order-interim',
	templateUrl: './order-interim.component.html'
})

export class OrderInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.OrderInterim[] = [];
	totalCount: string;
	loading: boolean;
    
    seqCode: string = 'order';
