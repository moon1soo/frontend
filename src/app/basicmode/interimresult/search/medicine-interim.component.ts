...
@Component({
	selector: 'medicine-interim',
	templateUrl: './medicine-interim.component.html'
})

export class MedicineInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.MedicineInterim[] = [];
	totalCount: string;
	loading: boolean;
    
	seqCode: string = 'medicine';
