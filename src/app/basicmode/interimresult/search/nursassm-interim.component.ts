...
@Component({
	selector: 'nursassm-interim',
	templateUrl: './nursassm-interim.component.html'
})

export class NursAssmInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.NursAssmInterim[] = [];
	totalCount: string;
	loading: boolean;
    
	seqCode: string = 'nursAssm';
