...
@Component({
 	selector: 'diagnosis-interim',
	templateUrl: './diagnosis-interim.component.html'
})

export class DiagnosisInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.DiagnosisInterim[] = [];
    totalCount: string;
	seqCode: string = 'diagnosis';
	loading: boolean;
