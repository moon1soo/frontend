...
@Component({
	selector: 'concern-interim',
	templateUrl: './concern-interim.component.html'
})

export class ConcernInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.ConcernInterim[] = [];
    totalCount: string;
	seqCode: string = 'concernPatient';
	loading: boolean;
