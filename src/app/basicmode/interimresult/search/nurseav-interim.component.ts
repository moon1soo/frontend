...
@Component({
	selector: 'nurseav-interim',
	templateUrl: './nurseav-interim.component.html'
})

export class NursEavInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.NursEavInterim[] = [];
	totalCount: string;
	loading: boolean;
    
	seqCode: string = 'nursEav';
