...
@Component({
	selector: 'path-interim',
	templateUrl: './path-interim.component.html'
})

export class PathInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.PathInterim[] = [];
	totalCount: string;
	loading: boolean;
    
	seqCode: string = 'pathology';
