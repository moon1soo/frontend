...
@Component({
	selector: 'nursdiag-interim',
	templateUrl: './nursdiag-interim.component.html'
})

export class NursDiagInterimComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.NursDiagInterim[] = [];
	totalCount: string;
	loading: boolean;
    
	seqCode: string = 'nursDiag';
