...
@Component({
	selector: 'medical-interim',
	templateUrl: './medical-interim.component.html'
})

export class MedicalInterimComponent implements OnInit, AfterViewInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.MedicalInterim[] = [];
	totalCount: string;

	loading: boolean;
    
	seqCode: string = 'visit';
