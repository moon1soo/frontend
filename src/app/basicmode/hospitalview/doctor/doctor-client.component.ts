...
@Component({
 	selector: 'doctor-client',
	templateUrl: './doctor-client.component.html'
})

export class DoctorClientComponent implements OnInit {
	@ViewChild('accDoctor') acc;
    ...
    ngOnInit() {
        ...
        let receive = this._dashboard.doctorStore$.subscribe(res => {
	...
	beforeChange(event: NgbPanelChangeEvent) {	
		...
		this.clientIdx = Number(idx);let text: FormControl = new FormControl('');
