...
@Component({
 	selector: 'medical-server',
	templateUrl: './medical-server.component.html'
})

export class MedicalServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;
	@Input('activeTab') activeTab: string;

	dataSource: Model.MedicalList[] = [];
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.MedicalList[]) {
