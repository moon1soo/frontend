...
@Component({
 	selector: 'medical-client',
	templateUrl: './medical-client.component.html'
})

export class MedicalClientComponent implements OnInit {
	@ViewChild('acc') acc;
	@Output() addgrid = new EventEmitter();	
    ...
    ngOnInit() {
        ...
        let receive = this._dashboard.medicalStore$.subscribe(res => {
