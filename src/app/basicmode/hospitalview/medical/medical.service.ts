...
export class MedicalService {
	...
	secCode: string =  'medical';
	serverData: Model.MedicalList[] = [];
	serverClone: Model.MedicalList[] = [];
	clientIdx: number = 1;
	...
	constructor(
		...
		console.log('데이터 목록 확인',this.serverClone);
	}
	// 수신진료과 목록 불러오기
	list(): Observable<any> {
