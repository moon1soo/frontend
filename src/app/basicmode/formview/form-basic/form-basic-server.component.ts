...
import { DxLoadPanelModule, DxDataGridModule, DxDataGridComponent } from 'devextreme-angular';
...
@Component({
 	selector: 'form-basic-server',
	templateUrl: './form-basic-server.component.html'
})

export class FormBasicServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.FormList[] = [];
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.FormList[]) {
