...
@Component({
 	selector: 'form-detail-server',
	templateUrl: './form-detail-server.component.html'
})

export class FormDetailServerComponent implements OnInit {
	@ViewChild(DxDataGridComponent) dataGrid: DxDataGridComponent;

	dataSource: Model.FormDetailList[] = [];
	...
	// 테이블 row 선택 이벤트
	addSelectData(data: Model.FormDetailList[]) {
